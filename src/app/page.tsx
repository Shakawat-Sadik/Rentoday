        ...
        <div className="mx-auto">
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <p className="mt-1 text-muted-foreground">The latest properties available right now</p>
            </div>
            <Link
              href="/listings"
          ...
          <div className="relative overflow-hidden rounded-3xl bg-primary px-8 py-14 text-center text-primary-foreground">
            ...
            <div className="relative z-10">
              ...
              <p className="mt-3 max-w-xl mx-auto text-primary-foreground/80">
                Join hundreds of property owners on RenToday. Get your listing in front of
                thousands of verified tenants across Dhaka — for free.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                <Button size="lg" variant="secondary" className="font-semibold min-w-[160px]" asChild>
