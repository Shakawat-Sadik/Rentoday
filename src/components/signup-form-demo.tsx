  ...
  return (
    <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-card p-4 md:rounded-2xl md:p-8">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="group/btn relative block h-10 w-full rounded-md bg-gradient-to-br from-primary to-primary/80 font-medium text-primary-foreground shadow-[0px_1px_0px_0px_var(--background)_inset,0px_-1px_0px_0px_var(--background)_inset]"
          type="submit"
        >
          Sign up &rarr;
          <BottomGradient />
        ...
        <div className="flex flex-col space-y-4">
          <button
            className="group/btn shadow-input relative flex h-10 w-full items-center justify-start space-x-2 rounded-md bg-background px-4 font-medium text-foreground dark:bg-card"
            type="submit"
          >
            <IconBrandGithub className="h-4 w-4 text-foreground/80" />
          ...
          <button
            ...
            type="submit"
          >
            <IconBrandGoogle className="h-4 w-4 text-foreground/80" />
            <span className="text-sm text-muted-foreground">
              Google
            </span>
            <BottomGradient />
          ...
          <button
            ...
            type="submit"
          >
            <IconBrandOnlyfans className="h-4 w-4 text-foreground/80" />
            <span className="text-sm text-muted-foreground">
              OnlyFans
            </span>
            <BottomGradient />
