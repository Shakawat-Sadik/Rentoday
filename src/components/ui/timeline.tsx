    ...
    >
      ...
      <div ref={ref} className="relative  mx-auto pb-20">
        ...
        <div
          style={{
            height: height + "px",
            backgroundImage: "linear-gradient(to bottom, transparent 0%, var(--border) 50%, transparent 99%)",
            WebkitMaskImage: "linear-gradient(to bottom, transparent 0%, black 10%, black 90%, transparent 100%)",
          }}
          className="absolute left-8 top-0 w-0.5 overflow-hidden md:left-8"
        >
          <motion.div
            style={{
              height: heightTransform,
              opacity: opacityTransform,
              backgroundImage: "linear-gradient(to top, var(--primary) 0%, var(--accent) 10%, transparent 100%)",
            }}
